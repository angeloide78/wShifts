...
export class CargoComponent extends GridComponent {
    // Atributos generales.
    display: boolean = false;
    titulo:string  = "Gestión de Cargos" ;
    array_objetos: Cargo[];
    nombre_fichero_csv: string = "cargos_wShifts.csv" ;

    constructor(public objetoService : CargoService) {
      super(objetoService) ;
