...
var BalanceService = (function () {
    ...
    BalanceService.prototype.send_data = function (datos, tipo) {
    ...
    BalanceService.prototype.extractData = function (res) {
        var body = res.json();
        return body || {};
    };
    BalanceService.prototype.handleError = function (error) {
