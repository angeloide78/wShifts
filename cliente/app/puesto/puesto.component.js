...
var puesto_service_1 = require("./puesto.service");
// Clase grid.
var GridComponent_1 = require('../grid-utils/GridComponent');
// Grid.
var PuestoComponent = (function (_super) {
    __extends(PuestoComponent, _super);
    function PuestoComponent(objetoService) {
        _super.call(this, objetoService);
        this.objetoService = objetoService;
        // Atributos generales.
        this.display = false;
        this.titulo = "Gestión de puestos";
        this.nombre_fichero_csv = "puestos_wShifts.csv";
        // Configuración del ag-grid.
        _super.prototype.configurarGrid.call(this);
    }
    PuestoComponent.prototype.recuperar = function () {
        this.filtro_recuperar = { activo: null, id: null, codigo: null,
            eq_id: null, asig_pend: 'N' };
        _super.prototype.recuperar.call(this);
    };
    PuestoComponent.prototype.showDialog = function () {
        this.display = true;
    };
    PuestoComponent.prototype.insertarFila = function () {
        var nuevoElemento = this.crearNuevaFilaDatos();
        this.gridOptions.api.addItems([nuevoElemento]);
    };
    PuestoComponent.prototype.mensajes2 = function (opcion) {
    ...
    PuestoComponent.prototype.validaciones = function (modelo) {
        // Bandera de estado.
        var ret = true;
    ...
    PuestoComponent.prototype.crearNuevaFilaDatos = function () {
        var nuevaFila = {
            id: 0,
            tipo_unit_id: 4,
            codigo: "",
    ...
    PuestoComponent.prototype.createColumnDefs = function () {
        return [
    ...
    PuestoComponent = __decorate([
        core_1.Component({
            selector: 'puesto',
            templateUrl: 'app/puesto/puesto.html',
            providers: [puesto_service_1.PuestoService]
        }), 
        __metadata('design:paramtypes', [puesto_service_1.PuestoService])
    ], PuestoComponent);
    return PuestoComponent;
}(GridComponent_1.GridComponent));
exports.PuestoComponent = PuestoComponent;
//# sourceMappingURL=puesto.component.js.map