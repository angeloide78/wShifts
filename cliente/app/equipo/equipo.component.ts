...
export class EquipoComponent extends GridComponent {
    // Atributos generales.
    display: boolean = false;
    titulo:string  = "Gestión de equipos de trabajo" ;
    array_objetos: Equipo[];
    nombre_fichero_csv: string = "equipos_wShifts.csv" ;

    constructor(public objetoService : EquipoService) {
      super(objetoService) ;
