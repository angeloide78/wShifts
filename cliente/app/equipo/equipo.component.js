...
// Grid.
var EquipoComponent = (function (_super) {
    __extends(EquipoComponent, _super);
    function EquipoComponent(objetoService) {
        _super.call(this, objetoService);
        this.objetoService = objetoService;
        // Atributos generales.
        this.display = false;
        this.titulo = "Gestión de equipos de trabajo";
        this.nombre_fichero_csv = "equipos_wShifts.csv";
        // Configuración del ag-grid.
        _super.prototype.configurarGrid.call(this);
    }
    EquipoComponent.prototype.recuperar = function () {
        this.filtro_recuperar = { activo: null, id: null, codigo: null,
            sf_id: null, asig_pend: 'N' };
        _super.prototype.recuperar.call(this);
    };
    EquipoComponent.prototype.showDialog = function () {
        this.display = true;
    };
    EquipoComponent.prototype.insertarFila = function () {
        var nuevoElemento = this.crearNuevaFilaDatos();
        this.gridOptions.api.addItems([nuevoElemento]);
    };
    EquipoComponent.prototype.mensajes2 = function (opcion) {
    ...
    EquipoComponent.prototype.validaciones = function (modelo) {
        // Bandera de estado.
        var ret = true;
    ...
    EquipoComponent.prototype.crearNuevaFilaDatos = function () {
        var nuevaFila = {
            id: 0,
            tipo_unit_id: 3,
            codigo: "",
    ...
    EquipoComponent.prototype.createColumnDefs = function () {
        return [
