...
var PlanificacionService = (function () {
    ...
    PlanificacionService.prototype.extractData = function (res) {
        var body = res.json();
        return body || {};
    };
    PlanificacionService.prototype.handleError = function (error) {
        var errMsg = (error.message) ? error.message :
            error.status ? error.status + " - " + error.statusText : 'Server error';
        console.error(errMsg);
        return Observable_1.Observable.throw(errMsg);
    };
    PlanificacionService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], PlanificacionService);
    return PlanificacionService;
}());
exports.PlanificacionService = PlanificacionService;
//# sourceMappingURL=planificacion.service.js.map