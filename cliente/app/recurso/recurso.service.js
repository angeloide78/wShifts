...
var RecursoService = (function () {
    ...
    RecursoService.prototype.send_data = function (datos, tipo) {
    ...
    RecursoService.prototype.extractData = function (res) {
        var body = res.json();
        return body || {};
    };
    RecursoService.prototype.handleError = function (error) {
