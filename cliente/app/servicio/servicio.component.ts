...
export class ServicioComponent extends GridComponent {
    // Atributos generales.
    display: boolean = false;
    titulo:string  = "Gestión de servicios" ;
    array_objetos: Servicio[];
    nombre_fichero_csv: string = "servicios_wShifts.csv" ;

    constructor(public objetoService : ServicioService) {
      super(objetoService) ;
